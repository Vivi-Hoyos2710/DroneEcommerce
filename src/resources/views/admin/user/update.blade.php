                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="sm:col-span-2">
                        <label for="Password Confirmation"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Admin Password
                            Confirmation</label>
                        <input type="password" id="admin_password" name="password"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Your Password">
                        <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Enter your
                            password as an administrator to see the reflected changes of the user update </p>
                        @if (session('error'))
