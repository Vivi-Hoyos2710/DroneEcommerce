    ...
    <div class="bg-white shadow-md mx-auto mt-8 p-4 w-96 rounded-lg">
        ...
        <div class="flex items-center space-x-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-500">{{ $viewData['userData']->getUserName() }}#{{ $viewData['userData']->getId() }}</p>
            </div>
        </div>
            ...
            <div class="space-y-2">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button data-modal-target="username-pop-up" data-modal-toggle="username-pop-up" class="text-blue-500">Edit</button>
                    </div>
                </div>
                <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button data-modal-target="email-pop-up" data-modal-toggle="email-pop-up" class="text-blue-500">Edit</button>
                    </div>
                </div>
                <div class="flex items-center justify-between">
                    <p class="text-gray-600">password *</p>
                    <button data-modal-target="password-pop-up" data-modal-toggle="password-pop-up" class="text-blue-500">Change</button>
                </div>
            </div>
            <div class="border-t pt-4">
