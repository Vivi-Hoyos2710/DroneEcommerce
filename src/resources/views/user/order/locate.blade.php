...
<html>
  ...
  <div class="container" style="display: flex; justify-content: center;"
    <div class="card-container" >
      <div class="panel">
        ...
        <form method="POST" action="{{ route('cart.purchase') }}">
          ...
          <!-- set a hidden input with the entire address as a value type="hidden"-->
          ...
          <button type="submit" id="purchase" class="bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full" disabled style="opacity: 0.5; background-color: #bdc3c7;
          ">Purchase</button>
      </form>
      </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAp0xD9szVZuzH2-R0lKL9nTYifnYQXuEE&libraries=places&callback=initMap&solution_channel=GMP_QB_addressselection_v1_cABC" async defer></script>
